	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
		...
		<form id="new-post" name="new-post" method="post">
			...
			<fieldset class="bbp-form">
				<legend><?php printf( esc_html__( 'Comments to: %s', 'bbpress' ), ( bbp_get_form_reply_to() ) ? sprintf( esc_html__( 'Reply #%1$s in %2$s', 'bbpress' ), bbp_get_form_reply_to(), bbp_get_topic_title() ) : bbp_get_topic_title() ); ?></legend>
				...
				<div>
					...
					<?php if ( bbp_is_subscriptions_active() && ! bbp_is_anonymous() && ( ! bbp_is_reply_edit() || ( bbp_is_reply_edit() && ! bbp_is_reply_anonymous() ) ) ) : ?>
						...
						<p>
							...
							<?php else : ?>
								...
								<!-- <label for="bbp_topic_subscription"><?php //esc_html_e( 'Notify me of follow-up replies via email', 'bbpress' ); ?></label> comments by sumeeth -->
					...
					<?php if ( bbp_is_reply_edit() ) : ?>
						...
						<?php if ( bbp_allow_revisions() ) : ?>
							...
							<!--comments by sumeeth <fieldset class="bbp-form">
								<legend>
