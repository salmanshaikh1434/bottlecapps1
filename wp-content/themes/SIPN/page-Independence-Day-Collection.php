<?php
/**
 * Template Name: SIPN Independence-Day-Collection
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='Independence-Day-Collection';

$query="SELECT * FROM wp_collections  WHERE collection_orgname='Independence Day Collection'";
            ...
            <div class="wrapper-bottom ptop25">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">Independence Day Collection</h2>
