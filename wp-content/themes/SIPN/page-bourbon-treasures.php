<?php
/**
 * Template Name: SIPN bourbon-treasures
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='bourbon-whiskey-treasures-discover-top-store-pick-bottles';
$query="SELECT * FROM wp_collections  WHERE collection_orgname='Bourbon whiskey treasures discover top store pick bottles'";
            ...
            <div class="wrapper-bottom ptop25">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">Bourbon Treasures: Top Store Pick Bottles to Hunt Down Now</h2>
