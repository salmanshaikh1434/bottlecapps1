<?php
/**
 * Template Name: SIPN Exquisite-Collection:-Celebrating-Black-OwnedBourbon-and-Rye
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='Exquisite-Collection-Celebrating-Black-OwnedBourbon-and-Rye';

$query="SELECT * FROM wp_collections  WHERE collection_orgname='Exquisite Collection Celebrating Black-Owned Bourbon and Rye'";
            ...
            <div class="wrapper-bottom ptop25">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">Exquisite Collection: Celebrating Black-Owned Bourbon & Rye</h2>
					...
					<div class="collection-room"><img src="<?php echo $masterdata[0]->collection_image; ?>"></div>
						<div class="about-collection">
							
							<p> <?php echo nl2br($masterdata[0]->collection_long_description); ?> </p>
						</div>
