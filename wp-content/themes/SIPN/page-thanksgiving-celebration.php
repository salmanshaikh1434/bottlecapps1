<?php
/**
 * Template Name: SIPN thanksgiving-celebrations
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='Must-Have-Bourbon Whiskeys-for-Thanksgiving-Celebration';
$query="SELECT * FROM wp_collections  WHERE collection_orgname='Must Have Bourbon Whiskeys for Thanksgiving Celebration'";
