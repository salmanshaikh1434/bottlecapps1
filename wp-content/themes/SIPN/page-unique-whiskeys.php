<?php
/**
 * Template Name: SIPN Unique whiskeys
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='unique-whiskeys-for-your-4th-of-july-celebration';
$query="SELECT * FROM wp_collections  WHERE collection_orgname='unique-whiskeys-for-your-4th-of-july-celebration'";
