<?php
/**
 * Template Name: SIPN Under-50-Bourbon-Batch
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='best-bourbon-under-50';
$query="SELECT * FROM wp_collections  WHERE collection_orgname='best bourbon under 50'";
            ...
            <div class="wrapper-bottom ptop25">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">best bourbon under $50</h2>
