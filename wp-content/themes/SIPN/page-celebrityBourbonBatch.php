<?php
/**
 * Template Name: SIPN Celebrity Bourbon Batch
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='Celebrity-Bourbon-Collection';
$query="SELECT * FROM wp_collections  WHERE collection_orgname='Celebrity Bourbon Collection'";
            ...
            <div class="wrapper-bottom ptop25">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">Celebrity bourbon</h2>
							...
							<div class="share_collections">
								...
								<div class="share_collections_icons" id="share_collections_icons" style="display:none;">
									<ul>
											...
											<li><a href="https://pinterest.com/pin/create/button/?url=<?php echo site_url();?>/bourbon-collection/<?php echo $val; ?>&description=<?php echo $val; ?>" target="_blank">
