<?php
/**
 * Template Name: SIPN Beyond The Barrel Blending Bourbon
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val= 'blended-bourbon-whiskey';
$query="SELECT * FROM wp_collections  WHERE collection_orgname='blended-bourbon-whiskey'";
                ...
                <div class="container">
                    <div class="col-md-12">
                    	<span class="collections-back">
                          ...
                          <h2 style="display: none;">best bourbon under $100</h2>
					...
					<div class="col-md-12">
					<div class="col-md-8 colle col-sm-12">
					...
					<div class="col-md-4 col-sm-12 collections-right">
