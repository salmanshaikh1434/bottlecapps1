<?php
/**
 * Template Name: SIPN best-whiskeys-for-old-fashioned
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='best-whiskeys-for-old-fashioned';
$query="SELECT * FROM wp_collections  WHERE collection_orgname='best whiskeys for old fashioned'";
            ...
            <div class="wrapper-bottom ptop25">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">Best Whiskeys to use for Old Fashioned Cocktail</h2>
