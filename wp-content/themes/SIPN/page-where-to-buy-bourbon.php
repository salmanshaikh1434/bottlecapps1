<?php
/**
 * Template Name: SIPN where to buy bourbon
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='where-to-buy-bourbon';
$query="SELECT * FROM wp_collections  WHERE collection_orgname='Where to buy bourbon'";
            ...
            <div class="wrapper-bottom">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">Where to buy bourbon</h2>
