<?php
/**
 * Template Name: SIPN Fathersday celabrations
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='top-bourbons-to-celebrate-national-bourbon-day';

$query="SELECT * FROM wp_collections  WHERE collection_orgname='top-bourbons-to-celebrate-national-bourbon-day'";
            ...
            <div class="wrapper-bottom ptop25">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">Crafting Exceptional Whiskey: Artisan Distilleries Creating Collectible Treasures.</h2>
					...
					<div class="collection-room"><img src="<?php echo $masterdata[0]->collection_image; ?>"></div>
						<div class="about-collection">
							...
							<p> <?php echo nl2br(strip_tags($masterdata[0]->collection_long_description)); ?> </p>
						</div>
