<?php
/**
 * Template Name: SIPN unwrap-the-holiday-spirit
 *
...
$val = 'christmas-bourbon-gift-guide-2023';
$query = "SELECT * FROM wp_collections  WHERE collection_orgname='christmas bourbon gift guide 2023'";
...
<style type="text/css">
	...
	.spr-content a:hover:first-child {
		border-radius: 8px 8px 0 0;
	}

	.spr-content a:hover:last-child {
		border-radius: 0px 0px 8px 8px;
	}

	.sort-price-rating:hover .spr-content {
		display: block;
	}

	.sort-price-rating:hover .spr-dropbtn {
		background-color: transparent;
	}
				...
				<div class="col-md-12">
					...
					<div class="share_collections">
						...
						<div class="share_collections_icons" id="share_collections_icons" style="display:none;">
							<ul>
								<li>
									<a href="https://www.facebook.com/sharer/sharer.php?text=Share Collection&amp;u=<?php echo site_url(); ?>/bourbon-collection/<?php echo $val; ?>"
										target="_blank">
										<i class="fa-brands fa-facebook-f" style="font-style: normal;"></i></a>
								</li>
								<li><a href="https://twitter.com/messages/compose?text=Share Collection <?php echo site_url(); ?>/bourbon-collection/<?php echo $val; ?>"
										target="_blank">
										<!-- <i class="fab fa-twitter"></i> -->
										<img src="/wp-content/themes/SIPN/assets/images/icon-twitter-gold.png">
									</a>
								</li>
								<li><a href="https://pinterest.com/pin/create/button/?url=<?php echo site_url(); ?>/bourbon-collection/<?php echo $val; ?>"
										target="_blank">
