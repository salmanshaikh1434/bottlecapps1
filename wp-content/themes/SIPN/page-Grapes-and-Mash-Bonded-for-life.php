<?php
/**
 * Template Name: SIPN Grapes-and-Mash-Bonded-for-life
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='Mash-and-grape-Bonded-for-life';

$query="SELECT * FROM wp_collections  WHERE collection_orgname='Mash and grape Bonded for life'";
            ...
            <div class="wrapper-bottom ptop25">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">Grapes and Mash – Bonded for life</h2>
					...
					<div class="collection-room"><img src="<?php echo $masterdata[0]->collection_image; ?>"></div>
						<div class="about-collection">
							...
							<p> <?php echo strip_tags($masterdata[0]->collection_long_description); ?> </p>
						</div>
