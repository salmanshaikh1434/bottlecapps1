<?php
/**
 * Template Name: SIPN Christmas Bourbon Batch
 *
...
// $val=$_GET['q'];
// $str = str_replace("-", " ", $val);
$val='Christmas-Bourbon-Collection';
$query="SELECT * FROM wp_collections  WHERE collection_orgname='Christmas Bourbon Collection'";
            ...
            <div class="wrapper-bottom ptop25">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <h2 style="display: none;">Christmas bourbon</h2>
